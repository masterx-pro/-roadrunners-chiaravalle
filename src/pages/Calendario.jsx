...
import { getSlotFissi, getEventiSpeciali, getAtleti, getCategorie, registraPresenza, salvaPresenzaSingola, getPresenze, aggiornaIscrittGara, aggiornaStatoPagamentoGara, creaEvento, aggiornaEvento, togglePartecipazione, toggleIscrizioneComunicata, creaCartellaGara, caricaDocumentoGara, getRuote, calcolaDisponibilitaRuote, assegnaRuote, getAssegnazioniRuote, rimuoviAssegnazioneRuote } from '../utils/sheetsApi'
...
function DettaglioGara({ gara, atleti, onBack, onUpdate, onEdit }) {
  ...
  useEffect(() => {
    async function caricaRuote() {
      try {
        const [ar, ruote] = await Promise.all([
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
            ...
            <button
              ...
              style={{ cursor: 'pointer', border: 'none', padding: '4px 10px', fontSize: '13px' }}
